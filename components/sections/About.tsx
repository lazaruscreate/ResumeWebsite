    ...
    <div>
      ...
      <div className="space-y-4 text-base leading-relaxed text-slate-400">
        <p>
          ...
          recently built cloud infrastructure and AI tooling while handling support requests at a software startup
          in its growth stages. Each role has been different enough to keep me sharp and similar enough to show me
