  ...
  return (
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="mt-8 flex gap-5 flex-wrap">
        ...
        <a
          href="https://www.flickr.com/photos/101266633@N05/albums/72157702868943924/with/30497795635"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Flickr"
          className="text-slate-500 transition-colors hover:text-slate-200 text-sm font-bold leading-6 tracking-tight"
        >
          flickr
        </a>
      </div>
